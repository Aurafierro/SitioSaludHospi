...
function validarCampos() {
  var estadonombre_persona_contacto = document.getElementById("nombre_persona_contacto");
  return validarNomPersonaContacto(nombre_persona_contacto);
}
function validarNomPersonaContacto(cuadroNumero) {
...
function validarCampos() {
  ...
  return validarTelPersonaContacto(telefono_persona_contacto);
}
function validarTelPersonaContacto(cuadroNumero) {
